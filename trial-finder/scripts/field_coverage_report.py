...
For every field listed in TAGGING_SPEC_v0.5.md section 2 ("Data source"),
...
# Field paths transcribed from TAGGING_SPEC_v0.5.md sec. 2's module table.
...
def main():
    ...
    lines.append(f"- Spec version: TAGGING_SPEC_v0.5.md section 2")
    lines.append("")
